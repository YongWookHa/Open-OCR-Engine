...
class Attention(nn.Module):
    ...
    def __init__(self, input_size, cfg):
        ...
        self.attention_cell = AttentionCell(input_size, cfg.hidden_size, cfg.num_class)
        self.hidden_size = cfg.hidden_size
        self.num_classes = cfg.num_class
        self.generator = nn.Linear(cfg.hidden_size, cfg.num_class)
    ...
    def forward(self, batch_H, text, is_train=True, max_seq_len=25):
        """
        input:
        ...
        num_steps = max_seq_len + 1  # +1 for [s] at end of sentence.
        ...
        if is_train:
            ...
            probs = torch.FloatTensor(batch_size, num_steps, self.num_classes).to(batch_H.device)
